...
int IsValid(int turn, int board[8][8] , int *positions)
{
    ...
    if(piece == 1){
        /*starting move*/
        if (initial.y == 6 && (final.y == initial.y -2||final.y==initial.y-1) && final.x == initial.x && board[final.y][final.x] == 0){
    ...
    /*black pawn*/
        ...
        /*starting move*/
        if (initial.y == 1 && (final.y == initial.y +2 ||final.y==initial.y +1 ) && final.x == initial.x && board[final.y][final.x] == 0){
